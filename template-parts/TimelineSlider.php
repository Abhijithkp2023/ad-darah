...
$timeline_headline = isset($timeline_headline) ? $timeline_headline : 'Rooted in <br /> Saudi  Identity';
...
<section class="timeline-slider pb_100 pt_100" data-timeline-slider>
	<div class="timeline-slider-bg">
		<img src="<?php echo get_template_directory_uri(); ?>/assets/images/rooted saudi.png"
			alt="Timeline Slider Background" />
	</div>
	<div class="container">
		...
		<div class="timeline-header">
			<div class="timeline-header-left">
				<?php if ($timeline_headline): ?>
					<h2 class="timeline-headline"><?php echo wp_kses($timeline_headline, array('br' => array())); ?></h2>
				<?php endif; ?>
			</div>
							...
							<?php if ($slide_image): ?>
								<div class="timeline-image">
									<img src="<?php echo esc_url($slide_image); ?>"
										alt="<?php echo esc_attr($timeline_headline . ' - ' . $slide_year); ?>">
								</div>
							<?php endif; ?>
