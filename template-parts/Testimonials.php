...
<section class="testimonials-container pt_80 pb_80">
    ...
    <div class="testimonials-swiper-section">
        ...
        <div class="testimonials-slider-wrapper testimonials-slider-top">
            <div class="testimonials-slider-track">
                <?php
                // Duplicate testimonials for seamless loop
                $top_testimonials = array_merge($testimonials, $testimonials);
        ...
        <div class="testimonials-slider-wrapper testimonials-slider-bottom">
            <div class="testimonials-slider-track">
                <?php
                // Duplicate testimonials for seamless loop
                $bottom_testimonials = array_merge($testimonials, $testimonials);
